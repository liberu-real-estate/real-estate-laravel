    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <h2 class="text-xl font-semibold mb-2">2. Use of Services</h2>
                <p class="mb-4">
                ...
                <h2 class="text-xl font-semibold mb-2">4. Property Listings</h2>
                <p class="mb-4">
                ...
                <h2 class="text-xl font-semibold mb-2">8. Changes to Terms</h2>
                <p class="mb-4">
