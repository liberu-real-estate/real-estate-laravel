            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="">
                            <a href="#" class="hover:underline font-xs">UK non-geographic: 01632 960000 to 960999</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline font-xs">UK London: 020 7946 0000 to 7946 0999</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline font-xs">UK mobile: 07700 900000 to 900999</a>
                        </li>
