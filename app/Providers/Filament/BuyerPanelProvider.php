...
class BuyerPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        $panel
            ...
            ->discoverResources(in: app_path('Filament/Buyer/Resources'), for: 'App\\Filament\\App\\Resources')
            ->discoverPages(in: app_path('Filament/Buyer/Pages'), for: 'App\\Filament\\App\\Pages')
            ->pages([
                Dashboard::class,
                Pages\EditProfile::class,
                Profile::class,
            ])
            ->discoverWidgets(in: app_path('Filament/Buyer/Widgets/Home'), for: 'App\\Filament\\App\\Widgets\\Home')
            ->widgets([
