...
LABEL org.opencontainers.image.title="Liberu Real Estate"
LABEL org.opencontainers.image.description="Production-ready Docker setup for Liberu Real Estate (Laravel Octane)"
LABEL org.opencontainers.image.source=https://github.com/liberu-real-estate/real-estate-laravel
